  ...
  render() {
    ...
    return (
      <div className="github-CommitView">
        ...
        <div className="github-CommitView-coAuthorEditor input-textarea native-key-bindings" contentEditable>
          <span className="github-CommitView-coAuthorEditor-label">Co-Authors</span>
          <ul className="github-CommitView-coAuthorEditor-list">
            <li className="github-CommitView-coAuthorEditor-listItem">@kuychaco</li>
            <li className="github-CommitView-coAuthorEditor-listItem">@smashwilson</li>
            <li className="github-CommitView-coAuthorEditor-listItem">@binarymuse</li>
          </ul>
        </div>
        <ul className="github-CommitView-coAuthorEditor-selectList">
          <li className="github-CommitView-coAuthorEditor-selectListItem is-selected">
            <span className="github-CommitView-coAuthorEditor-username">as-cii</span>
            <span className="github-CommitView-coAuthorEditor-name">Antonio Scandurra</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">damieng</span>
            <span className="github-CommitView-coAuthorEditor-name">Damien Guard</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">daviwil</span>
            <span className="github-CommitView-coAuthorEditor-name">David Wilson</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">iolsen</span>
            <span className="github-CommitView-coAuthorEditor-name">Ian Olsen</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">maxbrunsfeld</span>
            <span className="github-CommitView-coAuthorEditor-name">Max Brunsfeld</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">jasonrudolph</span>
            <span className="github-CommitView-coAuthorEditor-name">Jason Rudolph</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">lee-dohm</span>
            <span className="github-CommitView-coAuthorEditor-name">Lee Dohm</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">nathansobo</span>
            <span className="github-CommitView-coAuthorEditor-name">Nathan Sobo</span>
          </li>
          <li className="github-CommitView-coAuthorEditor-selectListItem">
            <span className="github-CommitView-coAuthorEditor-username">rsese</span>
            <span className="github-CommitView-coAuthorEditor-name">Robert Sese</span>
          </li>
        </ul>
  ...
  renderCoAuthorToggleIcon() {
    return (
      <svg className="github-CommitView-coAuthorToggleIcon" viewBox="0 0 12 7" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.875 2.125H12v1.75H9.875V6h-1.75V3.875H6v-1.75h2.125V0h1.75v2.125zM6 6.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5V6c0-1.316 2-2 2-2s.114-.204 0-.5c-.42-.31-.472-.795-.5-2C1.587.293 2.434 0 3 0s1.413.293 1.5 1.5c-.028 1.205-.08 1.69-.5 2-.114.295 0 .5 0 .5s2 .684 2 2v.5z"></path>
      </svg>
    );
  }
